...
function Navigation({ isOpen, onClosed }) {
  return (
    <div className={`Navigation${isOpen ? ' Navigation--open': ''}`}>
      <div className="Navigation__bg" onClick={onClosed} />
      <nav className={`Navigation__wrapper${isOpen ? ' Navigation__wrapper--open': ''}`}>
        <div className="Navigation__container">
          <div className="Navigation__content">
            <ul className="Navigation__list">
              {NAVIGATION_MOBILE.map(item => (
                <li key={item.id}>
                  <NavLink to={item.to} className="Navigation__link">{item.text}</NavLink>
                </li>
              ))}
            </ul>
          </div>
          ...
          <button type="button" className="Navigation__closed" onClick={onClosed}>
